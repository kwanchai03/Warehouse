...
<th > <div align="right">วันที่นำเข้า :'. thai_date_fullmonth(strtotime($objResult2['LastUpdate'])) . '</div></th>
         </tr>
         <tr>
...
<?php
  ...
  mysqli_set_charset($conn3, "utf8");
   $sql3 = "SELECT * FROM order_product WHERE order_id = '".$strCustomerID2."' ";
...
<h2 style="text-align:center"><img src="logowarehouse.png" alt="center"><br><br>Ware house จัดเก็บสินค้า
