			...
			<div class="fh5co-narrow-content">
				...
				<?php
                 ...
                 $dbname = "ware_house";
                  ...
                  $sql = "SELECT 
                  order_product_rogis.order_id,order_product_rogis.LastUpdate,order_product_rogis.weight,order_product_rogis.member_warehouse,order_user_rogis.cusname,order_user_rogis.Phonnumber,order_user_rogis.cuslive,order_user_rogis.empname,
                 ...
                 <div style="overflow-x:auto;" style="width: 1150px;">
                  ...
                  <tr bgcolor="#372754">
                   <th width="308"> <div align="center">รหัสใบเสร็จ </div></th>
                      <th width="680"> <div align="center">วันที่ซื้อ </div></th>
                 
                    <th width="598"> <div align="center">ผู้ซื้อ </div></th>
                   ...
                   <th width="598"> <div align="center">ที่อยู่ </div></th>
                    ...
                    <th width="350"> <div align="center">จัดเก็บ </div></th>
                     ...
                     ?>
                        ...
                        <td align="center"><div align="center"><a class='button2  confirmation' href="print2.php?order_id=<?php echo $objResult["order_id"];?>"><i class="fas fa-print  " style="font-size:36px"></i></a></div>
                         </td>
             
                         <td align="center"><div align="center"><a class='button2  confirmation' href="buy2.php?order_id=<?php echo $objResult["order_id"];?>"><i class="fa fa-edit" style="font-size:36px"></i></a></div>
                         </td>
