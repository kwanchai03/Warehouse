...
<form action="buy3.php" name="frmAdd" method="post">
  <tr class="txtMult">
   ...
   <td><div align="center"><input type="hidden" name="txtweight[]" value="<?php echo $objResult["weight"];?>"><?php echo $objResult["weight"];?>&nbsp;กิโลกรัม </div></td>
      ...
      <td><div align="center"><input type="hidden" name="txtalignc[]" value="<?php echo $objResult["warehouse_column"];?>"><?php echo $objResult["warehouse_column"];?> </div></td>
...
<myHero2>
 ...
 <a href="logis.php" type="submit" class="button1">กลับ</a>
