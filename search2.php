...
?>
  ...
  <tr>
    ...
    <tr width="130">
       <th> <div align="">ผู้จำหน่าย </div></th><th> <div align="">:<?php echo substr($objResult2["cusname"] ,3);?></div></th>  <th> <div align="">ที่อยู่ลูกค้า </div></th> <th> <div align="">:<?php echo $objResult2["cuslive"];?></div></th>
...
<myHero2>
 ...
 <a href="search.php" type="submit" class="button1">กลับ</a>
